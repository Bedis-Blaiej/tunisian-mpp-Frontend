...
const translations = {
  fr: {
    ...
    login: {
      ...
      forgotPasswordDesc: 'Nous allons te renvoyer un code pour réinitialiser ton mot de passe.',
      sendResetCode: 'Envoyer le code de réinitialisation',
      resetCodeSent: 'Code de réinitialisation envoyé à ton email.',
      enterResetCode: 'Entre le code que tu as reçu par email et définis un nouveau mot de passe.',
      ...
      passwordResetSuccess: 'Ton mot de passe a été réinitialisé avec succès.',
    },
    predictions: {
  ...
  en: {
    ...
    login: {
      ...
      forgotPasswordDesc: 'We\'ll send you a code to reset your password.',
      sendResetCode: 'Send reset code',
      resetCodeSent: 'Reset code sent to your email.',
      enterResetCode: 'Enter the code you received by email and set a new password.',
  ...
  ar: {
    ...
    login: {
      ...
      forgotPassword: 'نسيت الكلمة السرّة؟',
      forgotPasswordDesc: 'راحو نبعثولك كود لتغيّر كلمة السرّة متاعك.',
      sendResetCode: 'ابعثلي كود التغيير',
      resetCodeSent: 'تبعث كود التغيير لبريدك الإلكتروني.',
      enterResetCode: 'حط الكود لي وصلك عبر البريد وخمّن كلمة سرّة جديدة.',
      resetCodePlaceholder: 'كود التغيير',
      newPassword: 'كلمة السرّة الجديدة',
      confirmPassword: 'ثبّت كلمة السرّة',
      resetPassword: 'غيّر كلمة السرّة',
      passwordsDoNotMatch: 'كلمات السرّة ما تطابقوش.',
      passwordTooShort: 'كلمة السرّة لازم تكون ٦ أحرف على الأقل.',
      passwordResetSuccess: 'تغيّرت كلمة السرّة متاعك بنجاح.',
    },
    predictions: {
